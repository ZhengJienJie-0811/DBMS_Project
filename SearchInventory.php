...
if (!empty($keyword)) {
    $conditions[] = "(plan_number LIKE '%$keyword%' OR title LIKE '%$keyword%' OR document_code LIKE '%$keyword%' OR inventory_number LIKE '%$keyword%' OR budget_subject LIKE '%$keyword%')";
}

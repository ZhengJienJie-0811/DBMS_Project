        ...
        <?php if ($inventory_data): ?>
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="invoice_number" value="<?php echo htmlspecialchars($inventory_data['invoice_number'] ?? 'N/A'); ?>"></td>
                </tr>
                <tr>
                    <td>Title:</td>
            ...
            <tbody>
                <?php if (count($receipt_keeping_data) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td rowspan="2"><input type="text" name="account" value="<?php echo htmlspecialchars($Account ?? 'N/A'); ?>"></td>
                        <td><input type="text" name="unit_price" value="<?php echo htmlspecialchars($total_amount ?? 'N/A'); ?>"></td>
                        <td><input type="text" name="quantity" value="<?php echo htmlspecialchars($quantity?? 'N/A'); ?>"></td>
                        <td rowspan="2"><input type="text" name="health_insurance_employer" value="0"></td>
                        <td rowspan="2"><input type="text" name="total_due" value="<?php echo htmlspecialchars($total_amount ?? 'N/A'); ?>"></td>
                        ...
                        <td rowspan="2"><input type="text" name="net_amount" value="<?php echo htmlspecialchars($total_amount ?? 'N/A'); ?>"></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input type="text" name="description" value="<?php echo htmlspecialchars($total_amount ?? 'N/A'); ?>"></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr>
